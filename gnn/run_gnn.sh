...
#python gnn.py --weight-dim=128 --depth=50 --objective=D_p --features=C0,C1,CO,CC0,CC1,gtype --model=LSTMGCN --train-circuit=c3540 --test-circuit=c432 --problem=regression --loss=L1 --sigmoid
