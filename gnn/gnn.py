...
def load_data_with_model():
    ...
    graph_train = nx.readwrite.graphml.read_graphml('../data/graph/'+options.circuit_train+'_10e6.graphml')
    ...
    graph_test = nx.readwrite.graphml.read_graphml('../data/graph/'+options.circuit_test+'_10e7.graphml')
